...
<html lang="en" data-theme="light" data-assets-path="../assets/" data-layout-path="dashboard-free/" dir="ltr" class="scroll-smooth">
  <head>
    ...
    <title>Login - Pages | FlyonUI - Powered by FlyonUI</title>
  ...
  <body>
    <!-- Layout wrapper -->
    <!-- Content -->
    <div class="flex h-auto min-h-screen items-center justify-center overflow-x-hidden bg-[url('../../img/illustrations/auth-background-2.png')] bg-cover bg-center bg-no-repeat py-10">
      <div class="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-base-100 shadow-base-300/20 z-1 sm:min-w-md w-full space-y-6 rounded-xl p-6 shadow-md lg:p-8">
          ...
          <div class="space-y-4">
            <form class="mb-4 space-y-4" action="{{route('login.store')}}" method="POST">
                @csrf
              <div>
                <label class="label-text" for="userEmail">Email address*</label>
                <input type="email" placeholder="Enter your email address" name="email" class="input" id="userEmail" autocomplete="off" required />
              </div>
              <div>
                <label class="label-text" for="userPassword">Password*</label>
                <div class="input">
                  <input id="userPassword" type="password" name="password" placeholder="············" autocomplete="off" required />
              ...
              <div class="flex items-center justify-between gap-y-2">
                ...
                <a href="{{route('forgot-password.show')}}" class="link link-animated link-primary font-normal">Forgot Password?</a>
              </div>
            ...
            <p class="text-base-content/80 mb-4 text-center">
              New on our platform?
              <a href="{{url('register')}}" class="link link-animated link-primary font-normal">Create an account</a>
            </p>
            <div class="divider">or</div>
            <button class="btn btn-text btn-block">
              <img src="{{asset('/assets/img/icons/brands/google.png')}}" alt="google icon" class="size-5 object-cover" />
              Sign in with google
            </button>
          </div>
        </div>
