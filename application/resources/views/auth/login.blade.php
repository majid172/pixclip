...
<body>
    ...
    <div
        ...
        <div class="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
            ...
            <!-- Background Decorative SVG (Kept for styling) -->
            <div class="absolute">
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ url('/') }}" class="flex items-center gap-3">
                        <img src="{{ asset('/assets/images/logo.png') }}" alt="Logo"
                            class="w-16 sm:w-10 lg:w-10 h-10 object-contain" style="width: 250px;" />
                ...
                <div class="space-y-4">
                    <form class="mb-4 space-y-4" action="{{ route('login.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="email" placeholder="Enter your email address" name="email" class="input"
                                id="userEmail" autocomplete="off" required />
                        </div>
                        <div>
                    ...
                    <p class="text-base-content/80 mb-4 text-center">
                        New on our platform?
                        <a href="{{ url('register') }}" class="link link-animated link-primary font-normal">Create an
                            account</a>
                    </p>
