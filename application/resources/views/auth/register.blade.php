            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ url('/') }}" class="flex items-center gap-3">
                        <img src="{{ asset('/assets/images/logo.png') }}" alt="Logo"
                            class="w-16 sm:w-10 lg:w-10 h-10 object-contain" style="width: 200px;" />
                ...
                <div class="space-y-4">
                    <form class="mb-4 space-y-4" action="{{ route('register.store') }}" method="POST">
                        @csrf
                        <div>
                            <label class="label-text" for="userName">User Name <span class="text-error">*</span></label>
                            <input type="text" placeholder="Enter your user name" name="name" class="input"
                                id="userName" required />
                        </div>
                        <div>
                            <label class="label-text" for="userEmail">Email address <span
                                    class="text-error">*</span></label>
                            <input type="email" placeholder="Enter your email address" name="email" class="input"
                                id="userEmail" required />
                        </div>
                        <div>
                            <label class="label-text" for="userPassword">Password <span
                                    class="text-error">*</span></label>
                            <div class="input">
                        ...
                        <div>
                            <label class="label-text" for="userConfrimPassword">Confirm Password <span
                                    class="text-error">*</span></label>
                            <div class="input">
                                <input id="userConfrimPassword" type="password"
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <label class="label-text text-base-content/80 p-0 text-base" for="policyagreement">
                                ...
                                <a href="javascript:void(0)"
                                    class="link link-animated link-primary font-normal">privacy policy &
                                    terms?</a>
                            </label>
                        </div>
                    ...
                    <button class="btn btn-text btn-block">
                        <img src="{{ asset('/assets/img/icons/brands/google.png') }}" alt="google icon"
