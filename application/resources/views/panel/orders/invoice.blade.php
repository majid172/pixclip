        ...
        <div class="py-8 px-8 md:p-12 relative z-10">
            ...
            <div class="mb-4">
                <div class="flex justify-between items-start text-white mb-4">
                    <div>
                        @if ($order->is_paid)
                            <div class="mt-3 inline-block">
                                <span
                                    class="text-success px-4 py-2 text-xs font-bold uppercase tracking-wide border border-success rounded">
                                    Paid
                                </span>
                            </div>
                        @else
                            <div class="mt-3 inline-block">
                                <span
                                    class="text-warning bg-warning px-4 py-2 text-xs font-bold uppercase tracking-wide border border-warning rounded">
                                    Unpaid
                                </span>
                            </div>
                        @endif
                    ...
                    <div class="text-right">
                        <p class="text-md font-black font-semibold uppercase text-primary">Invoice No. :
                            #{{ $order->order_id }}</p>
                    </div>
                </div>
                <hr>
                ...
                <div class="flex-1 min-w-[280px] bg-base-200/50 rounded-xl p-6 border border-base-content/10">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between items-center">
                            ...
                            <span
                                class="font-semibold text-base-content text-sm">{{ dateFormat($order->created_at) }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-base-content/60 text-sm">Due Date:</span>
                            <span
                                class="font-semibold text-base-content text-sm">{{ dateFormat($order->created_at->addDays(7)) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            @foreach ($serviceNames as $key => $serviceId)
                                ...
                                <tr class="invoice-row  border-base-content/5 last:border-0">
                                    ...
                                    <td class="text-center py-4">
                                        ...
                                        @else
                                            <span
                                                class="text-sm text-base-content/80 font-medium">{{ $qty }}</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-right py-4">
                                        <div class="flex items-center justify-end gap-1">
                                            ...
                                            @else
                                                <span
                                                    class="text-sm text-base-content/80 font-medium">{{ number_format($price, 2) }}</span>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center py-4">
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            @else
                                                <span
                                                    class="text-sm text-base-content/60">{{ $single_discount }}%</span>
                                            @endif
                                        </div>
                                    </td>
                                ...
                                <tr class="invoice-row border-base-content/5 last:border-0">
                                    ...
                                    <td class="text-right font-bold text-base-content">
                                        <div class="flex items-center justify-end gap-1">
                                            ...
                                            @if ($is_admin)
                                                <input type="hidden" name="row_sub_total[]"
                                                    class="row_sub_total_input" value="0">
                                            @endif
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="flex justify-end mb-8">
                <div class="w-full max-w-md">
                    <div class="bg-base-200/30 rounded-xl p-6 border border-base-content/10 space-y-2">
            ...
            {{-- Footer Note --}}
            <div class="bg-base-200/30 rounded-xl p-4 border border-base-content/10 mb-2">
            ...
            {{-- Action Buttons --}}
            <div class="flex justify-between items-center print:hidden pt-2 border-t border-base-content/10">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (addRowBtn) {
            ...
            document.querySelectorAll('.invoice-row').forEach(row => {
                ...
                if (discountInput) discountInput.addEventListener('input', () => calculateRowTotal(
                    row));
            });
            ...
            if (footerDiscountTypeSelect) footerDiscountTypeSelect.addEventListener('change',
                calculateGrandTotal);
            ...
            if (invoiceRowsContainer) {
                addRowBtn.addEventListener('click', function() {
                    ...
                    if (priceInput) priceInput.addEventListener('input', () => calculateRowTotal(
                        newRow));
                    if (discountInput) discountInput.addEventListener('input', () => calculateRowTotal(
                        newRow));
