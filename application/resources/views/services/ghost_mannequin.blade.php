        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex flex-col text-left">
                ...
                <h1 class="text-slate-600 text-3xl md:text-4xl font-bold mb-6">
                    Capturing Images with Natural Depth :  <span class="text-blue-900">Ghost Mannequin Service</span>
                </h1>
    ...
    <section class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <div
                ...
                <a href="{{ route('free.trial') }}"
                    class="block w-full py-3 px-4 bg-blue-900 hover:bg-blue-800 text-white font-bold text-center rounded-lg border border-slate-200 transition-colors">
                    Contact Sales
                </a>
