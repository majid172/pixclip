        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-2 md:order-1">
                <h2 class="text-2xl md:text-3xl font-medium text-slate-600 mb-4 leading-tight">
                    ...
                    <span class="font-bold text-blue-900">Pen Tool magic</span>
                </h2>
                    ...
                    <li class="flex items-center gap-4">
                        <div class="flex-shrink-0 w-6 h-6 rounded-full bg-orange-50 flex items-center justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3"
                                stroke="currentColor" class="w-3 h-3 text-blue-900">
            ...
            <div class="order-1 md:order-2 relative flex justify-center items-center mt-12 md:mt-0">
                ...
                <div class="relative z-10 ">
                    <img src="{{ asset('/assets/images/images/background_remove/main_imge_2.png') }}" alt=" Jar"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div class="order-2 md:order-2">
                    <h2 class="text-2xl md:text-3xl font-medium text-slate-600 mb-4 leading-tight">
                        ...
                        <span class="font-bold text-blue-900">Wand Tool</span>
                    </h2>
                        ...
                        <li class="flex items-center gap-4">
                            <div class="flex-shrink-0 w-6 h-6 rounded-full bg-orange-50 flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="3" stroke="currentColor" class="w-3 h-3 text-blue-900">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                                </svg>
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                ...
                <div class="order-2 md:order-1">
                    <h2 class="text-2xl md:text-3xl font-medium text-slate-600 mb-4 leading-tight">
                        ...
                        <span class="font-bold text-blue-900">just $0.15!</span>
                    </h2>
    ...
    <section class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <div
                ...
                <a href="#"
                    class="block w-full py-3 px-4 bg-blue-900 hover:bg-blue-800 text-white font-bold text-center rounded-lg shadow-lg shadow-blue-500/30 transition-all hover:-translate-y-0.5">
                    Get Started
                </a>
