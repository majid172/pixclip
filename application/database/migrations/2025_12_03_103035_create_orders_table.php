...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->string('redo_order_id')->nullable();
            ...
            $table->string('output_media_id', 100)->nullable();

            $table->dateTime('submitted_at')->nullable();

            $table->tinyInteger('is_invoiced')->default(0);
            $table->tinyInteger('is_paid')->default(0);
            $table->integer('is_redo')->default(0);
            ...
            $table->string('output_redo_media_id', 100)->nullable();
            $table->string('output_redo_link', 255)->nullable();
            $table->timestamps();
