            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl mx-auto items-start">
                ...
                <div class="flex flex-col justify-center space-y-10 py-4">
                    ...
                    <div class="flex items-start group">
                        <div class="flex-shrink-0 flex items-center justify-center w-12 h-12 rounded-lg bg-rose-50 text-rose-600 group-hover:bg-rose-600 group-hover:text-white transition-colors duration-300">
                        ...
                        <form action="#" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="name" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 bg-gray-50 focus:bg-white focus:border-rose-600 focus:ring-4 focus:ring-rose-100 outline-none transition-all duration-300" placeholder="John Doe">
                                    </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="email" id="email" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 bg-gray-50 focus:bg-white focus:border-rose-600 focus:ring-4 focus:ring-rose-100 outline-none transition-all duration-300" placeholder="john@example.com">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="subject" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 bg-gray-50 focus:bg-white focus:border-rose-600 focus:ring-4 focus:ring-rose-100 outline-none transition-all duration-300" placeholder="Project Inquiry">
                                </div>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="message" rows="4" class="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 bg-gray-50 focus:bg-white focus:border-rose-600 focus:ring-4 focus:ring-rose-100 outline-none transition-all duration-300 resize-none" placeholder="Tell us about your project..."></textarea>
                                </div>
                            </div>

                            <!-- Attractive Button -->
                            <button type="button" class="group w-full bg-rose-600 text-white font-bold py-4 rounded-lg hover:bg-[#1a365d] hover:-translate-y-1 hover:shadow-lg transition-all duration-300 flex justify-center items-center">
