...
<nav class="bg-white shadow-sm sticky top-0 z-50">
    <div class="container mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
        ...
        <a href="#" class="flex items-center gap-2">
            <div class="w-8 h-8 relative">
                <div class="absolute inset-0 bg-blue-600 transform rotate-45 opacity-20"></div>
                <div class="absolute inset-0 flex items-center justify-center text-blue-900 font-bold text-xl">P</div>
            </div>
            <div class="flex flex-col leading-none">
                <span class="text-blue-900 font-bold text-lg tracking-tight">Pix Clipping</span>
        ...
        <div class="hidden lg:flex items-center space-x-8 text-[15px] font-medium text-blue-900">
            ...
            <a href="#" class="group flex items-center gap-1 hover:text-blue-600 transition">
                Services
            ...
            <a href="#" class="hover:text-blue-600 transition">Workflow</a>
            <a href="#" class="hover:text-blue-600 transition">Price</a>
            <a href="#" class="group flex items-center gap-1 hover:text-blue-600 transition">
                Resources
                <svg class="w-3 h-3 group-hover:rotate-180 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
            </a>
        ...
        <div class="hidden md:flex items-center gap-6">
            <div class="flex items-center gap-4 text-blue-900">
                ...
                <a href="#" class="hover:text-blue-600"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="2" y="2" width="20" height="20" rx="5" ry="5" stroke-width="2"></rect><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" stroke-width="2"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5" stroke-width="2"></line></svg></a>
            </div>
            <a href="#" class="bg-[#0a2e6b] hover:bg-blue-900 text-white px-6 py-2.5 rounded font-bold text-sm flex items-center gap-2 transition shadow-lg">
        ...
        <!-- Mobile Menu Toggle -->
        <div class="lg:hidden">
            <button id="mobile-menu-btn" class="text-blue-900 hover:text-blue-600 p-2 focus:outline-none">
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-white border-t border-gray-100">
        <div class="px-4 pt-2 pb-4 space-y-1">
            ...
            <a href="#" class="block mt-4 text-center bg-[#0a2e6b] text-white py-2 rounded font-bold">ORDER NOW</a>
        </div>
    </div>
</nav>
