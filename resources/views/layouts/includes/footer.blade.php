<!-- 4. FOOTER -->
<footer class="relative bg-[#0f172a] text-slate-300 font-sans border-t border-slate-800 overflow-hidden">
    <div class="absolute -top-24 -left-24 w-96 h-96 bg-rose-500/10 rounded-full blur-3xl pointer-events-none"></div>
    <div class="relative container mx-auto px-6 md:px-12 py-20">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <!-- Column 2: Important Links (Span 2 cols) -->
            ...
            <!-- Column 4: Contact & Tags (Span 3 cols) -->
            <div class="lg:col-span-3">
                ...
                <div class="mb-8">
                    ...
                    <a href="#" class="group relative inline-flex items-center gap-3 bg-gradient-to-r from-orange-400 to-amber-600 text-white px-6 py-3.5 text-xs font-bold tracking-widest uppercase rounded shadow-lg shadow-orange-900/40 hover:shadow-orange-500/40 transition-all duration-300 transform hover:-translate-y-1">
                        ...
                        <!-- Button Glow Effect -->
                        <div class="absolute inset-0 bg-white/20 blur opacity-0 group-hover:opacity-100 transition-opacity rounded"></div>
                    </a>
                </div>
    ...
    <!-- Bottom Bar -->
    <div class="bg-[#020617] border-t border-slate-800/50">
