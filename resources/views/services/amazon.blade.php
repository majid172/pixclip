        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div class="flex flex-col text-left">
                ...
                <h1 class="text-slate-600 text-3xl md:text-4xl font-bold mb-6">
                    Introducing Affordable : <span class="text-rose-600"> Amazon e-Bay Shopify Service</span>
                </h1>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <!-- Text Content -->
                    <h3 class="text-xl font-bold text-slate-600 mb-3">8000 /Days</h3>
    ...
    <section class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            ...
            <p class="text-slate-500 text-md">
                we uphold top-tier quality at competitive rates. Our pricing is transparent and all-inclusive, free from hidden fees
            </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
            ...
            <div
                ...
                <div class="my-6">
                    <span class="text-4xl font-extrabold text-slate-800">Talk to us</span>
                </div>
