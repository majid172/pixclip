                    ...
                    <div class="grid gap-4">
                        ...
                        <div class="border-base-content/20 rounded-box flex gap-4 border px-4 py-3">
                            ...
                            <div class="flex flex-col">
                                ...
                                <span class="text-base-content text-lg font-semibold truncate">
            ...
            <div class="card-body">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    @foreach($stats as $status => $count)
                        @php
                            $style = match($status) {
                                'Pending', 'In Review' => ['color' => 'text-warning', 'bg' => 'bg-warning/20', 'icon' => 'icon-[tabler--clock]'],
                                'Processing' => ['color' => 'text-info', 'bg' => 'bg-info/20', 'icon' => 'icon-[tabler--loader]'],
                                'Completed', 'Received', 'Finalizing', 'Downloaded' => ['color' => 'text-success', 'bg' => 'bg-success/20', 'icon' => 'icon-[tabler--check]'],
                                'Invoiced' => ['color' => 'text-secondary', 'bg' => 'bg-secondary/20', 'icon' => 'icon-[tabler--file-invoice]'],
                                'Canceled' => ['color' => 'text-error', 'bg' => 'bg-error/20', 'icon' => 'icon-[tabler--x]'],
                                default => ['color' => 'text-base-content', 'bg' => 'bg-base-content/10', 'icon' => 'icon-[tabler--box]']
                            };
                        @endphp
                        <div class="border-base-content/20 rounded-box flex gap-4 border px-4 py-3">
                            <div class="avatar avatar-placeholder">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-2">
                    ...
                    <div class="border-base-content/20 rounded-box flex gap-4 border px-4 py-3">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-base-content text-lg font-semibold truncate">${{ number_format($totalSpent, 2) }}</span>
                        </div>
                    </div>
                </div>
