...
<html lang="en" data-theme="light" data-assets-path="../assets/" data-layout-path="dashboard-free/" dir="ltr" class="scroll-smooth">
  <head>
    ...
    <!-- Vendor CSS -->
    <link rel="stylesheet" href="{{asset('public/assets/dist/libs/apexcharts/dist/apexcharts.css')}}" />
    <link rel="stylesheet" href="{{asset('public/assets/dist/libs/flyonui/src/vendor/apexcharts.css')}}" />
  ...
  <body>
    ...
    <!-- Page JS -->
    <script src="{{asset('public/assets/dist/js//common-dashboard-free.js')}}"></script>
